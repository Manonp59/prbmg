"""
Django settings for prbmg project.
...
# MEDIA_URL est l'URL qui gère les fichiers média servis depuis MEDIA_ROOT
MEDIA_URL = '/media/'
...
ROOT_URLCONF = 'prbmg.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR,'clustering/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'prbmg.wsgi.application'
